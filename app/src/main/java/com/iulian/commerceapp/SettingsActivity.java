...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button secureAccountBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullNameEditText= (EditText) findViewById ( R.id.settings_username );
        userPhoneEditText=(EditText) findViewById ( R.id.settings_phone_number );
        addressEditText=(EditText) findViewById ( R.id.settings_address );
        profileChangeTextBtn=(TextView) findViewById ( R.id.settings_profile_image_btn );
        closeTextBtn=(TextView) findViewById ( R.id.close_settings );
        saveTextBtn=(TextView) findViewById ( R.id.update_settings );
        secureAccountBtn=(Button) findViewById ( R.id.security_btn );

        userInfoDisplay(profileImageView,fullNameEditText,userPhoneEditText,addressEditText);

       secureAccountBtn.setOnClickListener ( new View.OnClickListener () {
           @Override
